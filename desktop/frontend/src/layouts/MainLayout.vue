  ...
  <div class="h-full flex">
    ...
    <aside class="w-56 bg-slate-800 border-r border-slate-700 flex flex-col">
      ...
      <div class="h-14 flex items-center px-4 border-b border-slate-700">
        ...
        <span class="ml-3 font-semibold text-white">AnixOps</span>
      </div>
      ...
      <div class="p-3 border-t border-slate-700">
        <div class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-700 cursor-pointer">
...
const PluginIcon = () => h('svg', { class: 'w-5 h-5', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
...
const PlaybookIcon = () => h('svg', { class: 'w-5 h-5', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
...
const menuItems = [
  ...
  { name: 'Playbooks', path: '/playbooks', icon: PlaybookIcon },
  { name: 'Users', path: '/users', icon: UsersIcon },
  { name: 'Agents', path: '/agents', icon: ComputerIcon },
