...
**Date**: 2026-03-23
**Status**: ✅ Released
**GitHub**: https://github.com/AnixOps/Anixops-control-center/releases/tag/v2.1.0-rc.5
...
## Recent Changes (v2.1.0-rc.5)
- Add ServiceDiscovery.vue with service listing and filtering
- Add discovery.store.test.js with 22 tests
- Web: 205, Mobile: 141, Workers: 405 tests
...
- Add utils.store.test.js with 19 tests
- Add date/time, byte, string, array utility tests
- Web: 124, Mobile: 141, Workers: 342 tests

## Recent Changes (v2.0.0-rc.25)
- Add api.store.test.js with 13 tests
- Add API error handling tests
- Web: 105, Mobile: 141, Workers: 342 tests
